...
tap_zerobaseline_f = preprocess.tapering(s, shift_min_to_zero=False)

# Taper data into the zerobaseline to remove the edge effect
tap_zerobaseline_t = preprocess.tapering(s, shift_min_to_zero=True)
...
tap_zerobaseline_w = preprocess.tapering(s, window=w, shift_min_to_zero=False)
