...
class TestECGReader(object):
    ...
    def test_on_valid_mit(self):
        file_name = os.path.abspath('tests/data/a103l')
    ...
    def test_on_valid_csv(self):
        file_name = os.path.abspath('tests/data/ecg_test1.csv')
    ...
    def test_on_csv_infer_sampling_rate(self):
        file_name = os.path.abspath('tests/data/ecg_test_w.csv')
        out = ECG_reader(file_name, 'csv', channel_name=['Time', '1'])
        assert round(out.sampling_rate) == 256
        file_name = os.path.abspath('tests/data/ecg_test2.csv')
...
class TestECGWriter(object):
    ...
    def test_on_valid_mit(self):
        file_in = os.path.abspath('tests/data/a103l')
    ...
    def test_on_valid_csv(self):
        file_in = os.path.abspath('tests/data/ecg_test1.csv')
