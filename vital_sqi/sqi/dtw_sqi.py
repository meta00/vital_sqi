...
def dtw_sqi(x, template_type=0):
    ...
    The dwt sqi output is the ratio between the sum of mapping distance and
    the trace of cost matrix.
    The closer to 1 the better SQI.

    Parameters
    ----------
    x :
        sequence, array of signal represent the template
    template_type :
        int, default = 0
    ...
    -------
    type
        float, the ratio score of matching with the chosen template
