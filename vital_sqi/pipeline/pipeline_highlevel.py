...
def get_ppg_sqis(file_name, signal_idx, timestamp_idx,sqi_dict,info_idx=None,
...
def get_qualified_ppg(file_name, signal_idx, timestamp_idx,sqi_dict={},
                 timestamp_unit='ms', sampling_rate=100, start_datetime=None,
                 split_type=0, duration=30, overlapping=None, peak_detector=7,
                 ruleset_order=None, rule_dict=None, segment_name=None,
